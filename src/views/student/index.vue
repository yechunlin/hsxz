<template>
    <div class="app-container">
        <div class="filter-container" style="margin:0 0 5px 0">
            <el-input v-model="listQuery.id" placeholder="学生id" style="width: 100px;" class="filter-item" @keyup.enter.native="handleFilter" />
            <el-input v-model="listQuery.username" placeholder="学生名" style="margin-left: 10px;width: 200px;" class="filter-item" @keyup.enter.native="handleFilter" />
        ...
        >
            ...
            <el-table-column label="年级" width="" align="center">
                <template slot-scope="{row}">
                    <span>{{ row.grade }}</span>
                </template>
            </el-table-column>
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="70px" style="width: 400px; margin-left:50px;">
                ...
                <el-form-item label="学校" prop="intro">
                    <el-input v-model="temp.school" />
                </el-form-item>
                <el-form-item label="年级" prop="intro">
                    <el-input v-model="temp.grade" />
                </el-form-item>
                <el-form-item label="地址" prop="intro">
                    <el-input v-model="temp.local" />
                </el-form-item>
            </el-form>
